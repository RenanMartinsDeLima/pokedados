document.addEventListener("DOMContentLoaded", () => {
    ...
    btnEncontrar.addEventListener("click", async () =>{
        ...
        try{
            ...
            pokemonNome.textContent = `${pokemonAtual.nome.charAt(0).toUpperCase() + pokemonAtual.nome.slice(1)}      Lv${nivel}`;
            pokemonDescricao.textContent = `Tipo: ${tipos} | Peso: ${peso}kg | Altura: ${altura}m`;
